...
sub test_run {
    ...
    like ($ret, qr/OK.*/, "ZSDeleteObject: cguid=$cguid nops=$num_objs");
    ...
    like ($ret, qr/OK.*/, "ZSMPut: update $num_objs objects keylen= $key_len datalen=$val_len to $cname, cguid=$cguid");
