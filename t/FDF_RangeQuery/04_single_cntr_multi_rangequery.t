...
# file: t/ZS_RangeQuery/04_single_cntr_multi_rangequery.t
# author: shujing zhu
# email: shujingzhu@hengtiansoft.com
# date: June 11, 2013
# description: range query cntr multi times
...
sub test_run {
    ...
    my @flags = ('ZS_RANGE_START_GE|ZS_RANGE_END_LE',
                 ...
                 'ZS_RANGE_START_LE|ZS_RANGE_END_GT',
                 'ZS_RANGE_START_LT|ZS_RANGE_END_GE',
                 'ZS_RANGE_START_LT|ZS_RANGE_END_GT',
                 'ZS_RANGE_START_GE|ZS_RANGE_END_LE|ZS_RANGE_INDEX_USES_DATA',
                 'ZS_RANGE_START_GE|ZS_RANGE_END_LT|ZS_RANGE_KEYS_ONLY',
                 'ZS_RANGE_START_GT|ZS_RANGE_END_LE|ZS_RANGE_PRIMARY_KEY',);
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            for (0 .. $multi_times-1){ 
                ...
                like($ret, qr/OK.*/,"ZSGetRange:Get $key ~ $end_key,keylen=$$d[0],flag=$flag ");
