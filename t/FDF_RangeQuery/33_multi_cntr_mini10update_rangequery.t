...
# file: t/ZS_RangeQuery/33_multi_cntr_mini10update_rangequery.t
# author: shujing zhu
# email: shujingzhu@hengtiansoft.com
# date: June 17, 2013
# description:  5 cntr0~4,start a minitrax :start 10 thread to update cntr, commit,range query cntr 
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            for(0 .. $ncntr - 1){
                ...
                like($ret, qr/OK.*/,"ZSGetRange:Get $key ~ $$d[2]+$key,cntr$_,cguid= $cguid[$_],flags=$flags");
