...
#
# file: t/ZS_RangeQuery/02_cntr_closed_rangequery.t
# author: shujing zhu
# email: shujingzhu@hengtiansoft.com
# date: June 11, 2013
# description:range query on closed cntr 
...
sub test_run {
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            like($ret, qr/SERVER_ERROR ZS_FAILURE_CONTAINER_NOT_OPEN.*/,"ZSGetRange on closed cntr fail ");
