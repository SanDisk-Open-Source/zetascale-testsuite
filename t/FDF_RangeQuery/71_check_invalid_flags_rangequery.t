...
sub test_run {
    ...
    my $val_offset = $key;
    my $size = 0;
	my $flags4 = 'ZS_RANGE_START_GE|ZS_RANGE_START_LE|ZS_RANGE_KEYS_ONLY' ;
	my $flags1 = 'ZS_RANGE_START_GE|ZS_RANGE_END_LE' ;
	my $flags2 = 'ZS_RANGE_START_LE|ZS_RANGE_KEYS_ONLY' ;
...
#				        start_key     => $key,
            ...
            like($ret, qr/SERVER_ERROR.*/,"ZSGetRange:keylen_end=$$d[0],end_key=$end_key,flags=$flags1->$ret");
...
#				        start_key     => $key,
            ...
            like($ret, qr/SERVER_ERROR.*/,"ZSGetRange:keylen_end=$$d[0],keylen_start=$$d[0],end_key=$end_key,flags=$flags2->$ret");
...
#                       end_key       => $end_key,
            ...
            like($ret, qr/SERVER_ERROR.*/,"ZSGetRange:keylen_end=$$d[0],start_key=$key,flags=$flags3->$ret");
