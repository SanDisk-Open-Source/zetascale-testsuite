...
#
# file: 45_multi_start_multi_end_rangequery.t
# author: Jing Xu(Lee)
...
sub test_run {
    ...
    my $val_offset = $key;
    my $size = 0;
    my $flags = 'ZS_RANGE_START_GE|ZS_RANGE_START_GT|ZS_RANGE_START_LE|ZS_RANGE_START_LT|ZS_RANGE_END_LE|ZS_RANGE_END_LT|ZS_RANGE_END_GE|ZS_RANGE_END_GT';
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            like($ret, qr/SERVER_ERROR ZS_FAILURE.*/,"Failed ZSGetRange:Get $key ~ $end_key,keylen_start=$$d[0],flags=$flags");
        }
