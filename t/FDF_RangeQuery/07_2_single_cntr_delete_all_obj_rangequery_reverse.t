...
# file: t/ZS_RangeQuery/07_2_single_cntr_delete_all_obj_rangequery_reverse.t
# author: shujing zhu
...
sub test_run {
    ...
    my $val_offset = $key;
    my $size = 0;
    my $flags = 'ZS_RANGE_START_LE|ZS_RANGE_END_GE|ZS_RANGE_PRIMARY_KEY'; 
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            like($ret, qr/OK.*/, "ZSDeleteObject:delete $$d[2] objects on $cname, cguid=$cguid");
            ...
            like($ret, qr/SERVER_ERROR ZS_QUERY_DONE.*/, "ZSGetNextRange:Get $n_out objects ,$ret");
