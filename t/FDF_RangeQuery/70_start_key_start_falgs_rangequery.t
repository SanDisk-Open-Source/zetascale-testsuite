...
#                       end_key       => $end_key,
            ...
            like($ret, qr/OK.*/,"ZSGetRange:keylen_start=$$d[0],start_key=$key,flags=$flags1 ->$ret");
...
#                       end_key       => $end_key,
            ...
            like($ret, qr/OK.*/,"ZSGetRange:keylen_end=$$d[0],keylen_start=$$d[0],start_key=$end_key.flags=$flags1->$ret");
...
#                       end_key       => $key,
            ...
            like($ret, qr/OK.*/,"ZSGetRange:keylen_start=$$d[0],start_key=$key,flags=$flags2,->$ret");
...
#				        keylen_end    => $$d[0],           
            ...
            like($ret, qr/OK.*/,"ZSGetRange:keylen_start=$$d[0],end_key=$key,start_key=$end_key,flags=$flags2,->$ret");
