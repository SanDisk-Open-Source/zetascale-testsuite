...
sub test_run {
    ...
    my $val_offset = $key;
    my $size = 0;
	my $flags1 = 'ZS_RANGE_START_GE|ZS_RANGE_END_LE|ZS_RANGE_KEYS_ONLY' ;
	my $flags2 = 'ZS_RANGE_START_LE|ZS_RANGE_END_GE' ;
    ...
    foreach my $p(@prop){
        foreach my $d(@data){
            ...
            like($ret, qr/OK.*/,"ZSGetRange with start_key=end_key=$key,flags=$flags1->$ret");
            ...
            like($ret, qr/OK.*/,"ZSGetRange with start_key=end_key=$key,flags=$flags2->$ret");
