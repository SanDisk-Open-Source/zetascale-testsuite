...
#
# file: 50_keystart_GT_keyend_rangequery.t 
# author: Jing Xu(Lee)
...
sub test_run {
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            like($ret, qr/OK.*/,"ZSGetRange:Get $end_key ~ $key,keylen_start=$$d[0],flags=$flags");
            ...
            like($ret, qr/SERVER_ERROR ZS_FAILURE.*/, "ZSGetNextRange:Get objects ,$ret");
