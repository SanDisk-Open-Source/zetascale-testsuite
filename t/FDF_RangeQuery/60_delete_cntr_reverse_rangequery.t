...
# file: t/ZS_RangeQuery/13_delete_cntr_rangequery.t
# author: shujing zhu
...
sub test_run {
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            like($ret, qr/SERVER_ERROR ZS_FAILURE_CONTAINER_NOT_FOUND.*/,"ZSGetRange $end_key ~$key,flags=$flags:->$ret");
        }
        ...
        $ret = ZSGetRange (
                    ...
                    keybuf_size   => 60, 
                    databuf_size  => 1024,
                    keylen_start  => $data[1][0],
                    keylen_end    => $data[1][0],           
                    start_key     => $end_key,
                    end_key       => $key,
                    flags         => $flags,
                    );
        like($ret, qr/OK.*/,"ZSGetRange $end_key ~$key,flags=$flags:->$ret");
        ...
        like($ret, qr/SERVER_ERROR ZS_FAILURE_CONTAINER_NOT_FOUND.*/ ,"ZSGetNextRange:->$ret");
