...
# file: 21_multi_cntr_flush_recovery_rangequery.t
# author: Jing Xu(Lee)
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            for(0 .. $ncntr - 1){
                ...
                like($ret, qr/OK.*/,"ZSGetRange:Get $end_key ~ $key,cntr$_,cguid=$cguid[$_],keylen_start=$$d[0],flags=$flags");
        ...
        for(0 .. $ncntr - 1){
            ...
            like($ret, qr/OK.*/, 'ZSFlushContainer');
        }
