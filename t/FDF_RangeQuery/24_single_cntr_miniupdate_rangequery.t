...
# file: t/ZS_RangeQuery/24_single_cntr_miniupdate_rangequery.t
# author: shujing zhu
# email: shujingzhu@hengtiansoft.com
# date: June 17, 2013
# description: range query after minitrax update
...
sub test_run {
    ...
    foreach my $d(@data){
        ...
        like($ret, qr/OK.*/, "ZSWriteObject, update $$d[2] objects on cguid=$cguid");
    }
    ...
    foreach my $d(@data){
        ...
        like($ret, qr/OK.*/, "ZSReadObject: check update $$d[2] objects succeed on $cname, cguid=$cguid");
    ...
    foreach my $d(@data){
        ...
        like($ret, qr/OK.*/, "ZSReadObject: check update $$d[2] objects succeed after restart ZS on $cname, cguid=$cguid");
    }
    $ret = ZSCloseContainer(
                $node->conn(0),
                cguid      => $cguid,
