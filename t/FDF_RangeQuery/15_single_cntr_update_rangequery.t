...
# file: t/ZS_RangeQuery/15_single_cntr_update_rangequery.t
# author: shujing zhu
...
sub test_run {
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            like($ret, qr/OK.*/, "ZSWriteObject: load $$d[2] objects keylen= $$d[0] datalen=$$d[1] to $cname, cguid=$cguid->$ret");
            ...
            like($ret, qr/OK.*/, "ZSWriteObject: update $update objects keylen=$$d[0] datalen=$$d[1] to $cname, cguid=$cguid->$ret");
            ...
            like($ret, qr/OK.*/, "ZSReadObject: check update $update objects succeed on $cname, cguid=$cguid->$ret");
