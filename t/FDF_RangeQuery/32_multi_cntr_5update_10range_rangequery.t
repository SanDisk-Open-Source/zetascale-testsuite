...
#
# file: t/ZS_RangeQuery/32_multi_cntr_5update_10range_rangequery.t
# author: shujing zhu
# email: shujingzhu@hengtiansoft.com
# date: June 17, 2013
# description:  5 cntr0~4,start 10 thread , 5 thread to update cntrs,10 threads range query cntr with two thread per cntr
...
sub test_run {
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            like($ret, qr/OK.*/, "ZSReadObject: check $update objects succeed on cntr2, cguid=$cguid[2]");
