...
#
# file: t/ZS_RangeQuery/57_single_cntr_mix_enum_read_reverse_rangequery.t
# author: shujing zhu
# email: shujingzhu@hengtiansoft.com
# date: June 11, 2013
# description: range query and enum cntr
...
sub test_run {
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            like($ret, qr/OK.*/,"ZSGetRange:Get $end_key ~ $key,keylen =$$d[0] ,flags=$flags");
