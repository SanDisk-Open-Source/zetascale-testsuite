...
#	my $flags = 'ZS_RANGE_START_GE|ZS_RANGE_END_LE|ZS_RANGE_KEYS_ONLY' ;
	my $flags1 = 'ZS_RANGE_START_GE|ZS_RANGE_END_GE' ;
	my $flags2 = 'ZS_RANGE_START_GE|ZS_RANGE_END_GT' ;
    ...
    foreach my $p(@prop){
        ...
        foreach my $d(@data){
            ...
            like($ret, qr/SERVER_ERROR.*/,"ZSGetRange:start_key=end_key=$key,flags=$flags1->$ret");
            ...
            like($ret, qr/SERVER_ERROR.*/,"ZSGetRange:start_key=end_key=$key,flags=$flags2->$ret");
        }
