...
#				    num_objs    => $data[0][2],
            ...
            like ($ret, qr/OK objs_written=0.*/, "ZSMPut:without num_obj,flags=$f-> $ret");
            ...
            like ($ret, qr/OK objs_written=0.*/, "ZSMPut:with num_obj=0 ,flags=$f-> $ret");
            ...
            like ($ret, qr/CLIENT_ERROR.*/, "ZSMPut:with num_obj=-1 ,flags=$f-> $ret");
