...
sub test_run {
   ...
   #my @data = ([50, 64000, 6250], [100, 128000, 6250], [150, 512, 37500]);
	...
	foreach my $d(@data){
		...
		like ($ret, qr/CLIENT_ERROR.*/, "ZSMPut: flags=NULL,->$ret ");
		...
		like ($ret, qr/CLIENT_ERROR.*/, "ZSMPut: flags=1 $ret");
		...
		like ($ret, qr/SERVER_ERROR.*/, "ZSMPut: flags=ZS_WRITE_MUST_EXIST , $ret");
		...
		like ($ret, qr/CLIENT_ERROR.*/, "ZSMPut without flags->$ret");
	}
