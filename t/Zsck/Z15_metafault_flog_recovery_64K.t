...
sub test_zsmetafault_and_zsck {
    ...
    my $zs_log_path="r/Zsck/Z15_metafault_flog_recovery_64K/zsck_container_".$c_id.".log";
    my $zs_metafault_log_path="r/Zsck/Z15_metafault_flog_recovery_64K/metafault.log";
...
#
{
   ...
   #     test_recovery();
        test_clean();
        copy("./r/Zsck/Z15_metafault_flog_recovery_64K/server.log", "./r/Zsck/Z15_metafault_flog_recovery_64K/server_".$c_id.".log");
    }
