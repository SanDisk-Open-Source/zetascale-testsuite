...
sub test_zsmetafault_and_zsck {
    ...
    my $zs_log_path="r/Zsck/Z19_metafault_potbitmap_recovery_64KB/log_container_".$c_id.".log";
    my $zs_metafault_log_path="r/Zsck/Z19_metafault_potbitmap_recovery_64KB/metafault.log";
