...
sub test_zsmetafault_and_zsck {
    ...
    my $zs_log_path="r/Zsck/Z06_metafault_shard_prop_recovery_128K/log_container_".$c_id.".log";
    my $zs_metafault_log_path="r/Zsck/Z06_metafault_shard_prop_recovery_128K/metafault.log";
    ...
    # zsmetafault test
    my $cmd = "";
    $cmd = $cmd . "$zsmetafault --container=".$c_id." --shard_prop 2>".$zs_metafault_log_path;
    print $cmd, "\n";
    system("$load_env $cmd");
...
#
{
    for($c_id=-1;$c_id<=2;$c_id++)
    {
        ...
        test_recovery();
        test_clean();
        copy("./r/Zsck/Z06_metafault_shard_prop_recovery_128K/server.log", "./r/Zsck/Z06_metafault_shard_prop_recovery_128K/server_".$c_id.".log");
     }
