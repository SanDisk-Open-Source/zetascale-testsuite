...
sub test_zsmetafault_and_zsck {
    ...
    my $zs_log_path="r/Zsck/Z22_metafault_slabbitmap_recovery_128K/log_container_".$c_id.".log";
    my $zs_metafault_log_path="r/Zsck/Z22_metafault_slabbitmap_recovery_128K/metafault.log";
...
#
{
    for($c_id=-1;$c_id<=2;$c_id++)
    {
        ...
        test_recovery();
        test_clean();
        copy("./r/Zsck/Z22_metafault_slabbitmap_recovery_128K.t/server.log","./r/Zsck/Z22_metafault_slabbitmap_recovery_128K.t/server".$c_id.".log");
    }
