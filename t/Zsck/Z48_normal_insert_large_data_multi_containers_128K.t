...
sub test_run
{
    ...
    foreach(@ctr_type) {
        ...
        like($ret,qr/^OK.*/, "Restart successfully.");
...
sub test_zsmetafault_and_zsck {
    ...
    my $zs_log_path="r/Zsck/Z48_normal_insert_large_data_multi_containers_128K/log_container_".$c_id.".log";
    my $zs_metafault_log_path="r/Zsck/Z48_normal_insert_large_data_multi_containers_128K/metafault.log";
...
#    }
    ...
    while(<LOG>)
    {
        if(/btree check/)
        {
            like($_, qr/btree check succeeded/, "btree check succeeded in zsck check.\n");
        }
    }
...
#
{
    for($c_id=-1;$c_id<=2;$c_id++)
    {
        ...
        test_run();
        test_clean();
        copy("./r/Zsck/Z48_normal_insert_large_data_multi_containers_128K/server.log", "./r/Zsck/Z48_normal_insert_large_data_multi_containers_128K/server_".$c_id.".log");
    }
