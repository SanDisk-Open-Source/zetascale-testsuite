...
sub test_zsmetafault_and_zsck {
    ...
    my $zs_log_path="r/Zsck/Z20_metafault_potbitmap_recovery_128KB/log_container_".$c_id.".log";
    my $zs_metafault_log_path="r/Zsck/Z20_metafault_potbitmap_recovery_128KB/metafault.log";
...
#
{
    for($c_id=-1;$c_id<=2;$c_id++)
    {
        ...
        test_recovery();
        test_clean();
        copy("./r/Zsck/zsck_recovery_check/server.log", "./r/Zsck/zsck_recovery_check/server_".$c_id.".log")
    }
