...
sub test_zsmetafault_and_zsck {
    ...
    my $zs_log_path="r/Zsck/Z21_metafault_slabbitmap_recovery_64K/log_container_".$c_id.".log";
    my $zs_metafault_log_path="r/Zsck/Z21_metafault_slabbitmap_recovery_64K/metafault.log";
