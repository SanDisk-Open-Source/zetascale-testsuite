...
sub test_zsmetafault_and_zsck {
    ...
    my $zs_log_path="r/Zsck/Z16_metafault_flog_recovery_128K/zsck_container_".$c_id.".log";
    my $zs_metafault_log_path="r/Zsck/Z16_metafault_flog_recovery_128K/metafault.log";
...
#        test_recovery();
        test_clean();
        copy("./r/Zsck/Z16_metafault_flog_recovery_128K/server.log", "./r/Zsck/Z16_metafault_flog_recovery_128K/server_".$c_id.".log");
    }
