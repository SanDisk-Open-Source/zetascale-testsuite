...
sub test_recovery {
    ...
    subtest "Test with ctnr c0" => sub {
        ...
        $cguid = $1 if($ret =~ /OK cguid=(\d+)/);
        ReadObjects($node->conn(0),$cguid,1000,50,1000,128000,500);
...
sub test_zsmetafault_and_zsck {
    ...
    my $zs_log_path="r/Zsck/Z24_normal_insert_large_data_128K/log_container_".$c_id.".log";
    my $zs_metafault_log_path="r/Zsck/Z24_normal_insert_large_data_128K/metafault.log";
...
#
{
    for($c_id=-1;$c_id<=2;$c_id++)
    {
            ...
            test_recovery();
            test_clean();
            copy("./r/Zsck/Z24_normal_insert_large_data_128K/server.log", "./r/Zsck/Z24_normal_insert_large_data_128K/server_".$c_id.".log");
    }
