...
# email: Jie Wang@hengtiansoft.com
# date: Apr 25, 2015
# description:
...
sub worker{
    ...
    if ($mode =~ /.*mode=1.*/){
        like($ret, qr/SERVER_ERROR ZS_FAILURE_OPERATION_DISALLOWED.*/, 'ZSTransactionCommit, expect return SERVER_ERROR ZS_FAILURE_OPERATION_DISALLOWED');
    }elsif ($mode =~ /.*mode=2.*/){
