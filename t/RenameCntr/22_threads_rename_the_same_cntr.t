...
sub test_run {
    ...
    foreach my $p(@prop){
        ...
        @threads = ();
            ...
            {
		$cname="ctr-$_";
                push(@threads, threads->new (\&worker_rename, $node->conn(2*$_), $cguids[$_],  $cname, '1'));
                push(@threads, threads->new (\&worker_rename, $node->conn(2*$_+1), $cguids[$_],  $cname, '0'));
            }
