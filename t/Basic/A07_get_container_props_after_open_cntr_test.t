...
sub test_run {
    ...
    #my @data = ([50, 64000, 50000], [100, 128000, 50000], [150, 512, 300000]);
    my @data = ([64, 16000, 25000], [74, 32000, 25000], [84, 64000, 25000], [94, 128000, 25000], [104, 48,500000]);
